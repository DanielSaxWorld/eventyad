    ...
    <table style='max-width: 620px; background-color: #ffffff; padding: 30px; border-radius: 8px;'>
        ...
        <tr>
            <td>
                ...
                <p>Hello,</p>
                <p>A login to your FD Mobile account was just detected:</p>
                <p><strong>Device:</strong> {$userAgent}</p>
                <p><strong>IP Address:</strong> {$ipAddress}</p>
                <p><strong>Date & Time:</strong> {$currentDateTime}</p>
                <p>If this was not you, please reset your password or contact support immediately.</p>
                <br>
                <p>Best regards,<br><strong>FD MOBILE SUPPORT</strong></p>
            </td>
        </tr>
        <tr>
            <td style='text-align: center; font-size: 12px; color: #aaa; padding-top: 30px;'>
                &copy; 2024 FD Mobile. All rights reserved.
            </td>
        </tr>
    </table>
</center>
